...
public class Individual {
    private StringProperty Date,Party,Fish,Qty,Rate,Subt,Total,Old,Grand,Debit,Balance;
    
    public Individual(String date,String party,String fish,String qty,String rate,String subt,String total,String old,String grand,String debit,String balance){
    ...
    public void setDebit(String credit){
        Debit.set(credit);
    }
